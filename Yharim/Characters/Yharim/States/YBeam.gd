...
func _frame_1():
	...
	if host.AchSkin and not host.nill:
	...
	if host.AchSkin and host.touhou:
		timed_particle_scene = load("res://Yharim/Characters/Yharim/Fx/Beams/BeamParticleEffectSPARK.tscn")
	if host.nill:
		timed_particle_scene = load("res://Yharim/Characters/Yharim/Fx/Beams/BeamParticleEffectSolar.tscn")
	host.hitlag_ticks += 5
